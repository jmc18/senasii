...
<div class="calendario-calibracion-form">
        ...
        <div class="panel-body">                
            <div class="row">
                ...
                <div class="col-md-4 col-xs-12">
                    ...
                    ?>
                    <!--<= Html::a('Imprimir Cotización', ['/cotizaciones/cotizaciones/report','idcot'=>$model->idcot], ['class'=>'btn btn-primary btn-block']) ?>-->
                    <?= Html::a('Regresar', ['/cotizaciones/cotizaciones/listado'], ['class'=>'btn btn-primary btn-block']) ?>
                    <?php \yiister\gentelella\widgets\Panel::end() ?>
                </div>
            </div>
        </div>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">Seleccionar Ensayos de Calibración</h3>
        </div>
        <div class="panel-body">
    <?= 
        GridView::widget([
            'dataProvider' => $data_calibracion,
            'columns' => [
                [
                    'header'=> 'Area',
                ...
                [
                    ...
                    'template' => '{agregar}',
                    'buttons' => [
                        'agregar' => function($url, $model) use ($model_cte)
                        {
                            if($model->idestatus0->idestatus != 3 && $model->idestatus0->idestatus != 6 )
                            {
                                ...
                                return Html::a('<span class="glyphicon glyphicon-plus"> Agregar</span>',
                                     ['agregarcalibracion', 'idarea' => $model->idarea, 'idref'=>$model->idreferencia, 'idcte'=>$model_cte->idcte, 'costo'=>$model->costo, 'estatus'=>$model->idestatus0->idestatus], 
                                     [
                                        'data-toggle'=>'tooltip',
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">Ensayos de Calibración Cotizados</h3>
        </div>
        <div class="panel-body">
        ...
        <div class="panel-body">
            <?=
                ...
                'columns' => [
                    ...
                    [
                        'header'=> 'Intervalo',
                        'value' => 'idarea0.intervalo'
                    ],
                    'idarea0.periodoini:date',
                    'idarea0.peridodfin:date',
                    'idarea0.fecinicio:date',
                    [   
                        'format'=>'html',
                        'header'=> 'Estatus',
                        'value' => function ($dataProvider) {

                            switch($dataProvider->idarea0->idestatus0->idestatus)
                            {
                                case 1: return Html::bsLabel($dataProvider->idarea0->idestatus0->descestatus, Html::TYPE_PRIMARY);
                                case 2: return Html::bsLabel($dataProvider->idarea0->idestatus0->descestatus, Html::TYPE_WARNING);
                                case 3: return Html::bsLabel($dataProvider->idarea0->idestatus0->descestatus, Html::TYPE_DANGER);
                                case 4: return Html::bsLabel($dataProvider->idarea0->idestatus0->descestatus, Html::TYPE_WARNING);
                    ...
                    [
                        ...
                        'buttons' => [
                            ...
                            {
                                if($model->idarea0->idestatus0->idestatus != 3)
                                {
                                    return Html::a('<span class="glyphicon glyphicon-trash"> Eliminar</span>',
                                         ['eliminarensayocalibracion', 'idarea' => $model->idarea, 'idref'=>$model->idreferencia, 'idcot'=>$model->idcot, 'idcte'=>$model_cte->idcte], 
                                         [
                                            'data-toggle'=>'tooltip',
                                            'data-placement'=>'bottom',
                                            'title'=> "Eliminar ensayo de la cotización",
                ...
                [
                    ...
                    'value' => function ($dataProvider) {
                        ...
                        switch($dataProvider->idrama0->idestatus0->idestatus)
                        {
                            ...
                            case 2: return Html::bsLabel($dataProvider->idrama0->idestatus0->descestatus, Html::TYPE_SUCCESS);
