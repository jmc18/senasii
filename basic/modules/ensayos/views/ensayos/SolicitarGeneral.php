...
$this->title = 'Selección de Ensayos';
...
<div class="calendario-calibracion-form">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">Selección de Ensayos</h3>
        </div>
     ...
     <?= 
        GridView::widget([
            ...
            [
                ...
                'template' => '{delete}',
                'buttons' => [
                    'delete' => function($idcte, $model) use ($idcte)
                    {
                        // CUANDO EL ESTATUS ES IGUAL A 3 INDICA QUE EL ENSAYO ESTA CANDELADO
                        if($model->idestatus0->idestatus != 3)
                        {
                            return Html::a('<span class="glyphicon glyphicon-ok"></span>',
                                 ['guardarensayogeneral', 'idrama' => $model->idrama,'idsubrama' => $model->idsubrama, 'idanalito'=>$model->idanalito, 'idref'=>$model->idreferencia, 'idcte'=>$idcte], 
                                 [
