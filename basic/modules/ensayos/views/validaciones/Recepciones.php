...
$this->title = 'Recepción del Elemento de Ensayo';
...
<div class="calendario-calibracion-form">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h1 class="panel-title">Validar Recepción de los Elementos de Ensayo</h1>
        </div>
            ...
            'columns' => [
                    [
                        ...
                        'value' => function ($dataEnsayosCalibracion) {
                            ...
                            if($dataEnsayosCalibracion->valida_recepcion != null)
                        ...
                        'buttons' => [
                            'ver' => function($url, $model)
                            {
                                return Html::a('<span class="glyphicon glyphicon-check"></span> Ver Archivos',
                                     ['listararchivos', 'idarea' => $model->idarea, 'idref'=>$model->idreferencia, 'idcot'=>$model->idcot, 'idetapa'=>5], 
                                     [
            ...
            GridView::widget([
                    ...
                    [
                        ...
                        'value' => function ($dataEnsayosGenerales) {
                            ...
                            if($dataEnsayosGenerales->valida_recepcion != null)
                                return Html::bsLabel('VALIDADO', Html::TYPE_SUCCESS);
                            else
                                return Html::bsLabel('SIN VALIDAR', Html::TYPE_DANGER);
                        }
                    ...
                    [
                        ...
                        'buttons' => [
                            ...
                            {
                                return Html::a('<span class="glyphicon glyphicon-check"></span> Ver Archivos',
                                     ['listararchivosgen', 'idrama' => $model->idrama,'idsubrama' => $model->idsubrama, 'idanalito'=>$model->idanalito, 'idref'=>$model->idreferencia, 'idcot'=>$model->idcot, 'idetapa'=>5], 
                                     [
                                        'class'=>'btn btn-default btn-xs btn-block',
                                     ]
                                );
