...
<div class="calendario-calibracion-form">
    ...
    <?php
        $form = ActiveForm::begin([
            'action' => ['cotizaciones/crear']
        ]);
    ?>

    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">Listado de Cotizaciones de Calibración Realizadas</h3>
        </div>
                ...
                'buttons' => [
                    'update' => function($url, $model)
                    {
                        return Html::a('<span class="glyphicon glyphicon-edit"> Editar</span>',
                             ['editar', 'idcot' => $model->idcot, 'idcte' => $model->idcte], 
                             [
                                'data-toggle'=>'tooltip',
                ...
                'buttons' => [
                    'delete' => function($url, $model)
                    {
                        return Html::a('<span class="glyphicon glyphicon-trash"> Borrar</span>',
                             ['eliminarcalibracion', 'idcot' => $model->idcot, 'idcte' => $model->idcte], 
                             [
                                'data-toggle'=>'tooltip',
                                'data-placement'=>'bottom',
