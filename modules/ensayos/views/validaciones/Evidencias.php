                        ...
                        'buttons' => [
                            'validar' => function($url, $model) {
                                if ($model->validado == null) {
                                    return Html::a('<span class="glyphicon glyphicon-check"></span> Aceptar', ['aceptarevidencia', 'idarea' => $model->idarea, 'idref' => $model->idreferencia, 'idcot' => $model->idcot, 'idetapa' => $model->idetapa, 'nofiles' => $model->nofiles], [
